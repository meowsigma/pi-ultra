...
- [ ] **Step 6: Set fork version `0.55.1-ultra.1`**, export `./launch-authority`, document the compatibility API, run GREEN/regressions, and commit `feat: enforce launch authority at execution ingress`.
