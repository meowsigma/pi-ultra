...
test('registers one command/tool, removes passive input interception, and appends manager policy to the active model', async () => {
  ...
  assert.deepEqual([...h.pi.tools.keys()], ['ultra_pool_status', 'ultra_begin_scope', 'ultra_takeover', 'ultra_record_review_findings', 'ultra_dispose_handoff', 'ultra_review_candidate', 'ultra_materialize_handoff', 'ultra_delegate']);
