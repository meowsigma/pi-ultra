...
test('manager mode denies parent mutation until an urgent scoped takeover is durable', async () => {
  ...
  assert.deepEqual([...pi.tools.keys()].sort(), ['ultra_begin_scope', 'ultra_delegate', 'ultra_dispose_handoff', 'ultra_materialize_handoff', 'ultra_pool_status', 'ultra_record_review_findings', 'ultra_review_candidate', 'ultra_takeover']);
